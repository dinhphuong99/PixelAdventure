...
public class PlayerAnimation : MonoBehaviour
{
    ...
    private float takeDamageTime = 0.7f;
    private float takeDamageTimer = 0f;

    private int currentCharacter = 0;

    private enum AllCharacterState { Player_Revival, Player_Death, Player_TakeDamage }
    ...
    private void UpdateAnimationState()
    {
        ...
        {
            ChangeAnimationState(AllCharacterState.Player_TakeDamage.ToString());
        }
