...
public class SpikeHeadAnimation : MonoBehaviour
{
    ...
    private WallHitSpikeHead wallHitSpikeHead;
    ...
    void Start()
    {
        ...
        wallHitSpikeHead = GetComponent<WallHitSpikeHead>();
        currentState = "Blink";
    }
    ...
    private void Update()
    {
        ...
        if (wallHitSpikeHead.GetCheckTouchingBottomWall() || wallHitSpikeHead.GetCheckTouchingTopWall())
        {
            topBottomHit = true;
        }
        else
        ...
        if (wallHitSpikeHead.GetCheckTouchingLeftWall() || wallHitSpikeHead.GetCheckTouchingRightWall())
        {
            leftRightHit = true;
        }
        else
